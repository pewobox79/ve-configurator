...
function App() {
    ...
    return (
        <><Jumbotron fluid>
            <Container>
                <h1>VE Configurator</h1>
                <p>
                    We can costumize your next Virtual Event. Choose the modules below and we can make your event
                    unique!
                </p>
            </Container>
        </Jumbotron>
        <div className="wrapper">
            ...
            <section>
                <Container className="text-center ">
                    <Button variant="outline-warning" onClick={window.print}>Print your Virtual Event proposal</Button>
                </Container>
            </section>
        </div>
            </>
